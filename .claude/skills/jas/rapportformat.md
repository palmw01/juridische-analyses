...
Vermeld eerst de structuurpositie van het artikel, **letterlijk overgenomen uit het `pad`-veld van de MCP-response** (string gescheiden door ` > `):
...
- [ ] §2: structuurpositie letterlijk overgenomen uit het `pad`-veld van de MCP-response — nooit aangenomen of afgeleid uit artikelinhoud
