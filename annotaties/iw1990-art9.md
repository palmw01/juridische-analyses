...
*Scope: lid 1. Overige leden nog niet geannoteerd.*

| Nr | Markering (letterlijk incl. lidwoord en verwijzingen) | JAS-klasse | Interpretatiemethode | Begrip | Signalering |
|----|------------------------------------------------------|-----------|---------------------|--------|-------------|
| 1 | "Een belastingaanslag is invorderbaar zes weken na de dagtekening van het aanslagbiljet." | **afleidingsregel** | grammaticaal | [[begrippen/invorderbaarheid-belastingaanslag]] | — |
| 2 | "Een belastingaanslag" | **rechtsobject** | grammaticaal | [[begrippen/belastingaanslag]] | ⚠ brondefinitie: art. 2 lid 1 onderdeel m IW 1990 — omvat voorlopige aanslag, aanslag, uitnodiging tot betaling, navorderingsaanslag en naheffingsaanslag |
| 3 | "is invorderbaar" | **rechtsbetrekking** | grammaticaal | [[begrippen/invorderbaarheid]] | — |
| 4 | "de dagtekening van het aanslagbiljet" | **rechtsfeit** | systematisch | [[begrippen/dagtekening-aanslagbiljet]] | ⚠ ook uitlegbaar als tijdsaanduiding (rij 7); dagtekening is zowel het triggerende rechtsfeit als de peildatum voor de termijnberekening |
| 5 | "zes weken na de dagtekening van het aanslagbiljet" | **tijdsaanduiding** | grammaticaal | [[begrippen/zes-weken-na-dagtekening-aanslagbiljet]] | — |
| 6 | "zes weken" | **parameter** | grammaticaal | [[begrippen/zes-weken]] | — |
| 7 | "de dagtekening van het aanslagbiljet" | **tijdsaanduiding** | grammaticaal | [[begrippen/dagtekening-aanslagbiljet]] | ⚠ ook uitlegbaar als rechtsfeit (rij 4); zie aldaar |
| 8 | "na" | **operator** | grammaticaal | — | — |

## Diagram

### Diagram 1 — lid 1: invorderbaarheid van een belastingaanslag

```mermaid
graph LR
    RB["rechtsbetrekking<br/>'is invorderbaar'"]:::rb
    RO["rechtsobject<br/>'belastingaanslag'"]:::ro
    RF["rechtsfeit<br/>'dagtekening aanslagbiljet'"]:::rf
    AR["afleidingsregel<br/>'aanslag invorderbaar zes weken…'"]:::ar
    TA["tijdsaanduiding<br/>'zes weken na dagtekening…'"]:::ta
    PA["parameter<br/>'zes weken'"]:::pa
    OP["operator<br/>'na'"]:::op
